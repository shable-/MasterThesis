...
west = np.load('/import/sun-data/hable/epsCC_10/F1_4/averages/arrays/average_F1_4_ZNE_west.npy')
east = np.load('/import/sun-data/hable/epsCC_10/F1_4/averages/arrays/average_F1_4_ZNE_east.npy')
...
ax1 = plt.gca()
ax1.plot(date[0:-4], westeps, c='Teal', lw=1.8, label='westside')
ax1.plot(date[0:-4], easteps, c='Turquoise', lw=1.8, label='eastside')
ax1.legend(loc=4, prop={'size':12})
#ax1.set_title('0.25-1.0 Hz \n', fontsize = 13)
ax1.set_ylabel('$\Delta$v/v (%) \n', fontsize = 12)
fig.add_subplot(2,1,2)
ax2 = plt.gca()
ax2.plot(date[0:-4], westCC, c='Teal', lw=1.8, label='westside')
ax2.plot(date[0:-4], eastCC, c='Turquoise', lw=1.8, label='eastside')
...
plt.savefig('/import/sun-data/hable/posterplots_new/east_west10_F1_4.pdf')
plt.close()
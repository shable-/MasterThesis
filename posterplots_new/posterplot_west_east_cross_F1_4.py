...
# PLOTPOSTER ZNE
dates = np.load('/import/walchen-data/hable/STACK/W1_4/dates.npy')
...
west = np.load('/import/sun-data/hable/epsCC_30/F1_4/averages2/arrays/average_F1_4_ZNE_west.npy')
east = np.load('/import/sun-data/hable/epsCC_30/F1_4/averages2/arrays/average_F1_4_ZNE_east.npy')
cross = np.load('/import/sun-data/hable/epsCC_30/F1_4/averages2/arrays/average_F1_4_ZNE_cross.npy')
...
ax1.plot(date, crosseps, c='MidnightBlue', lw=1.8, label='crossing')
...
ax2.plot(date, crossCC, c='MidnightBlue', lw=1.8, label='crossing')
...
plt.savefig('/import/sun-data/hable/posterplots_new/east_west_cross_F1_4.pdf')
plt.close()
...
cross = np.load('/import/sun-data/hable/epsCC_30/F025_1/averages/arrays/average_F025_1_ZNE_fault.npy')
...
ax2.plot(date, crossCC, c='MidnightBlue', lw=1.8, label='near fault')
...
plt.savefig('/import/sun-data/hable/posterplots_new/east_west_fault_F025_1.pdf')
plt.close()
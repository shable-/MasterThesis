...
ax1.fill_between(date, botheps_f1-rms1, botheps_f1+rms1, alpha=0.4, facecolor='Gray', edgecolor='Gray')
...
plt.savefig('/import/sun-data/hable/posterplots_new/ZNE_F025_1.pdf')
plt.close()
...
ax1.fill_between(date, botheps_f2-rms2, botheps_f2+rms2, alpha=0.4, facecolor='Gray', edgecolor='Gray')
ax1.set_ylabel('$\Delta$v/v (%) \n', fontsize = 12)
fig.add_subplot(2,1,2)
ax2 = plt.gca()
...
plt.savefig('/import/sun-data/hable/posterplots_new/ZNE_F05_2.pdf')
plt.close()
...
fig.add_subplot(2,1,1)
ax1 = plt.gca()
im = ax1.scatter(date[0:-1], botheps_f3, c=bothquality_f3, vmin=0.0, vmax=1.0, cmap='YlOrRd', edgecolor='None', s=25, zorder=200)
#ax1.errorbar(date[0:-1], botheps_f3, yerr=rms3, fmt=None, ecolor='k', zorder=1)
ax1.fill_between(date[0:-1], botheps_f3-rms3, botheps_f3+rms3, alpha=0.4, facecolor='Gray', edgecolor='Gray')
ax1.set_ylabel('$\Delta$v/v (%) \n', fontsize = 12)
fig.add_subplot(2,1,2)
ax2 = plt.gca()
ax2.scatter(date[0:-1], bothCC_f3, c=bothquality_f3, vmin=0.0, vmax=1.0, cmap='YlOrRd', edgecolor='None', s=25)
ax2.set_ylabel('correlation coefficient \n \n', fontsize = 12)
...
plt.savefig('/import/sun-data/hable/posterplots_new/ZNE_F1_4.pdf')
plt.close()
...
west = np.load('/import/sun-data/hable/epsCC_30/F025_1/averages2/arrays/average_F025_1_ZNE_west.npy')
east = np.load('/import/sun-data/hable/epsCC_30/F025_1/averages2/arrays/average_F025_1_ZNE_east.npy')
cross = np.load('/import/sun-data/hable/epsCC_30/F025_1/averages2/arrays/average_F025_1_ZNE_cross.npy')
...
plt.savefig('/import/sun-data/hable/posterplots_new/east_west_cross_F025_1.pdf')
plt.close()
...
west = np.load('/import/sun-data/hable/epsCC_10/F05_2/averages/arrays/average_F05_2_ZNE_west.npy')
east = np.load('/import/sun-data/hable/epsCC_10/F05_2/averages/arrays/average_F05_2_ZNE_east.npy')
...
plt.savefig('/import/sun-data/hable/posterplots/east_west_F05_2.pdf')
plt.close()
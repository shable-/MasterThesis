...
west = np.load('/import/sun-data/hable/epsCC_10/F025_1/averages/arrays/average_F025_1_ZNE_west.npy')
east = np.load('/import/sun-data/hable/epsCC_10/F025_1/averages/arrays/average_F025_1_ZNE_east.npy')
...
plt.savefig('/import/sun-data/hable/posterplots_new/east_west10_F025_1.pdf')
plt.close()
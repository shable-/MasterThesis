...
west = np.load('/import/sun-data/hable/epsCC_30/F025_1/averages/arrays/average_F025_1_ZNE_west.npy')
east = np.load('/import/sun-data/hable/epsCC_30/F025_1/averages/arrays/average_F025_1_ZNE_east.npy')
...
ax1.plot(date, easteps, c='SteelBlue', lw=1.8, label='eastside', zorder=20000)
ax1.plot(date, westeps, c='MidnightBlue', lw=1.8, label='westside', zorder=20000)
...
ax2 = plt.gca()
ax2.plot(date, eastCC, c='SteelBlue', lw=1.8, label='eastside', alpha=1.0)
ax2.plot(date, westCC, c='MidnightBlue', lw=1.8, label='westside', alpha=1.0)
...
plt.savefig('/import/sun-data/hable/posterplots_new/east_west_F025_1.pdf')
plt.close()
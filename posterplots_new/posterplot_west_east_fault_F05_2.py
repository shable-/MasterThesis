...
cross = np.load('/import/sun-data/hable/epsCC_30/F05_2/averages/arrays/average_F05_2_ZNE_fault.npy')
...
plt.savefig('/import/sun-data/hable/posterplots_new/east_west_fault_F05_2.pdf')
plt.close()
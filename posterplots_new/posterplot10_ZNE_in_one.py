...
#print(rms1[1040:1060])
#print()
#print(bothCC_f1[1040:1060])
#print()
#print(botheps_f1[1040:1060])

#rms1[np.isnan(rms1)] = 0
#rms2[np.isnan(rms2)] = 0
#rms3[np.isnan(rms3)] = 0

print(rms1[1040:1060])

fig.add_subplot(2,1,1)
ax1 = plt.gca()
ax1.plot(date, botheps_f1, c='Orange', lw=1.8, label='0.25-1.0 Hz')
#ax1.fill_between(date, botheps_f1-rms1, botheps_f1+rms1, alpha=0.2, facecolor='Orange', edgecolor='Orange')
ax1.plot(date, botheps_f2, c='OrangeRed', lw=1.8, label='0.5-2.0 Hz')
#ax1.fill_between(date, botheps_f2-rms2, botheps_f2+rms2, alpha=0.2, facecolor='OrangeRed', edgecolor='OrangeRed')
ax1.plot(date[0:-4], botheps_f3, c='FireBrick', lw=1.8, label='1.0-4.0 Hz')
#ax1.fill_between(date[0:-4], botheps_f3-rms3, botheps_f3+rms3, alpha=0.2, facecolor='FireBrick', edgecolor='FireBrick')
...
ax2.plot(date[0:-4], bothCC_f3, c='FireBrick', lw=1.8, label='1.0-4.0 Hz')
...
plt.savefig('/import/sun-data/hable/posterplots_new/ZNE10_in_one.pdf')
plt.close()

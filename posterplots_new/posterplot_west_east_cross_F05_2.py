...
west = np.load('/import/sun-data/hable/epsCC_30/F05_2/averages2/arrays/average_F05_2_ZNE_west.npy')
east = np.load('/import/sun-data/hable/epsCC_30/F05_2/averages2/arrays/average_F05_2_ZNE_east.npy')
cross = np.load('/import/sun-data/hable/epsCC_30/F05_2/averages2/arrays/average_F05_2_ZNE_cross.npy')
...
plt.savefig('/import/sun-data/hable/posterplots_new/east_west_cross_F05_2.pdf')
plt.close()
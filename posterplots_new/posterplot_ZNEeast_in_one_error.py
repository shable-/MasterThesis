...
ar_f1 = np.load('/import/sun-data/hable/epsCC_30/F025_1/averages/arrays/average_F025_1_ZNE_east.npy')
ar_f2 = np.load('/import/sun-data/hable/epsCC_30/F05_2/averages/arrays/average_F05_2_ZNE_east.npy')
ar_f3 = np.load('/import/sun-data/hable/epsCC_30/F1_4/averages/arrays/average_F1_4_ZNE_east.npy')
...
fig.suptitle('\n Relative velocity change and correlation coefficients for eastern stations, \n' \
...
ax1.fill_between(date, botheps_f1-rms1, botheps_f1+rms1, alpha=0.3, facecolor='YellowGreen', edgecolor='YellowGreen')

ax1.plot(date, botheps_f2, c='OliveDrab', lw=1.8, label='0.5-2.0 Hz', zorder=200)
ax1.fill_between(date, botheps_f2-rms2, botheps_f2+rms2, alpha=0.2, facecolor='OliveDrab', edgecolor='OliveDrab')
...
ax2.plot(date, bothCC_f2, c='OliveDrab', lw=1.8, label='0.5-2.0 Hz')
...
plt.savefig('/import/sun-data/hable/posterplots_new/ZNEeast_in_one.pdf')
plt.savefig('/home/shable/Desktop/MasterThesis/masterthesis_plots/ZNEeast_in_one.pdf')
plt.close()

...
# PLOTPOSTER ZNE
dates = np.load('/import/walchen-data/hable/STACK_30/W025_1/dates.npy')
...
ar_f1 = np.load('/import/sun-data/hable/epsCC_30/F025_1/averages/arrays/average_F025_1_ZNE.npy')
ar_f2 = np.load('/import/sun-data/hable/epsCC_30/F05_2/averages/arrays/average_F05_2_ZNE.npy')
ar_f3 = np.load('/import/sun-data/hable/epsCC_30/F1_4/averages/arrays/average_F1_4_ZNE.npy')
...
ax1 = plt.gca()
ax1.plot(date, botheps_f1, c='Orange', lw=1.8, label='0.25-1.0 Hz', zorder=200)
ax1.annotate('San Simeon', xy=(sansimeon, -0.10), xycoords='data', xytext=(-50, 30))
...
ax1.plot(date[0:-1], botheps_f3, c='FireBrick', lw=1.8, label='1.0-4.0 Hz', zorder=200)
...
plt.savefig('/home/shable/Desktop/MasterThesis/posterplots_talk/ZNE_in_one.pdf')
plt.close()

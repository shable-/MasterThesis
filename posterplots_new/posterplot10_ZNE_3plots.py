...
plt.savefig('/import/sun-data/hable/posterplots/ZNE10_F025_1_new.pdf')
plt.close()
...
fig.add_subplot(2,1,1)
ax1 = plt.gca()
im = ax1.scatter(date, botheps_f2, c=bothquality_f2, vmin=0.0, vmax=1.0, cmap='YlOrRd', edgecolor='None', s=25)
ax1.set_ylabel('$\Delta$v/v (%) \n', fontsize = 12)
fig.add_subplot(2,1,2)
ax2 = plt.gca()
...
plt.savefig('/import/sun-data/hable/posterplots/ZNE10_F05_2_new.pdf')
plt.close()
...
fig.add_subplot(2,1,1)
ax1 = plt.gca()
im = ax1.scatter(date[0:-4], botheps_f3, c=bothquality_f3, vmin=0.0, vmax=1.0, cmap='YlOrRd', edgecolor='None', s=25)
ax1.set_ylabel('$\Delta$v/v (%) \n', fontsize = 12)
fig.add_subplot(2,1,2)
ax2 = plt.gca()
...
plt.savefig('/import/sun-data/hable/posterplots/ZNE10_F1_4_new.pdf')
plt.close()
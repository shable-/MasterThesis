...
west = np.load('/import/sun-data/hable/epsCC/F05_2/averages2/arrays/average_F05_2_ZNE_west.npy')
east = np.load('/import/sun-data/hable/epsCC/F05_2/averages2/arrays/average_F05_2_ZNE_east.npy')

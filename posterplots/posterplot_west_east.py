...
west = np.load('/import/sun-data/hable/epsCC/F025_1/averages2/arrays/average_F025_1_ZNE_west.npy')
east = np.load('/import/sun-data/hable/epsCC/F025_1/averages2/arrays/average_F025_1_ZNE_east.npy')
...
plt.savefig('/import/sun-data/hable/posterplots/east_west_F025_1.pdf')
plt.close()
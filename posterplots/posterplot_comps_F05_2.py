...
# PLOTPOSTER ZNE
dates = np.load('/import/sun-data/hable/STACK/W05_2/dates.npy')
...
NN = np.load('/import/sun-data/hable/epsCC/F05_2/averages2/arrays/average_F05_2_NN.npy')
NE = np.load('/import/sun-data/hable/epsCC/F05_2/averages2/arrays/average_F05_2_NE.npy')
NZ = np.load('/import/sun-data/hable/epsCC/F05_2/averages2/arrays/average_F05_2_NZ.npy')
EN = np.load('/import/sun-data/hable/epsCC/F05_2/averages2/arrays/average_F05_2_EN.npy')
EE = np.load('/import/sun-data/hable/epsCC/F05_2/averages2/arrays/average_F05_2_EE.npy')
EZ = np.load('/import/sun-data/hable/epsCC/F05_2/averages2/arrays/average_F05_2_EZ.npy')
ZN = np.load('/import/sun-data/hable/epsCC/F05_2/averages2/arrays/average_F05_2_ZN.npy')
ZE = np.load('/import/sun-data/hable/epsCC/F05_2/averages2/arrays/average_F05_2_ZE.npy')
ZZ = np.load('/import/sun-data/hable/epsCC/F05_2/averages2/arrays/average_F05_2_ZZ.npy')
...
fig.suptitle('\n Relative velocity change for all stations, ' \
	     'frequency band: 0.5-2.0 Hz', fontsize=15, fontweight='bold')
...
plt.savefig('/import/sun-data/hable/posterplots/comps_eps_F05_2.pdf')
plt.close()
...
plt.savefig('/import/sun-data/hable/posterplots/comps_CC_F05_2.pdf')
plt.close()

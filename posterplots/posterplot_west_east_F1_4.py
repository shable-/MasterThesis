...
west = np.load('/import/sun-data/hable/epsCC/F1_4/averages2/arrays/average_F1_4_ZNE_west.npy')
east = np.load('/import/sun-data/hable/epsCC/F1_4/averages2/arrays/average_F1_4_ZNE_east.npy')
...
plt.savefig('/import/sun-data/hable/posterplots/east_west_F1_4.pdf')
plt.close()
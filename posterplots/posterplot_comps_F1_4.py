...
# PLOTPOSTER ZNE
dates = np.load('/import/sun-data/hable/STACK/W1_4/dates.npy')
...
NN = np.load('/import/sun-data/hable/epsCC/F1_4/averages2/arrays/average_F1_4_NN.npy')
NE = np.load('/import/sun-data/hable/epsCC/F1_4/averages2/arrays/average_F1_4_NE.npy')
NZ = np.load('/import/sun-data/hable/epsCC/F1_4/averages2/arrays/average_F1_4_NZ.npy')
EN = np.load('/import/sun-data/hable/epsCC/F1_4/averages2/arrays/average_F1_4_EN.npy')
EE = np.load('/import/sun-data/hable/epsCC/F1_4/averages2/arrays/average_F1_4_EE.npy')
EZ = np.load('/import/sun-data/hable/epsCC/F1_4/averages2/arrays/average_F1_4_EZ.npy')
ZN = np.load('/import/sun-data/hable/epsCC/F1_4/averages2/arrays/average_F1_4_ZN.npy')
ZE = np.load('/import/sun-data/hable/epsCC/F1_4/averages2/arrays/average_F1_4_ZE.npy')
ZZ = np.load('/import/sun-data/hable/epsCC/F1_4/averages2/arrays/average_F1_4_ZZ.npy')
...
fig.suptitle('\n Relative velocity change for all stations, ' \
	     'frequency band: 1.0-4.0 Hz', fontsize=15, fontweight='bold')
...
plt.savefig('/import/sun-data/hable/posterplots/comps_eps_F1_4.pdf')
plt.close()
...
plt.savefig('/import/sun-data/hable/posterplots/comps_CC_F1_4.pdf')
plt.close()
